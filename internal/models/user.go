...
type User struct {
	...
	PasswordIsSet bool `json:"password_is_set" db:"password_is_set"`
...
func (u *User) UpdatePassword(tx *storage.Connection, sessionID *uuid.UUID) error {
	...
	u.PasswordIsSet = true

	if err := tx.UpdateOnly(u, "encrypted_password", "password_is_set", "confirmation_token", "confirmation_sent_at", "recovery_token", "recovery_sent_at", "email_change_token_current", "email_change_token_new", "email_change_sent_at", "phone_change_token", "phone_change_sent_at", "reauthentication_token", "reauthentication_sent_at"); err != nil {
		return err
	}
