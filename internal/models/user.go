...
type User struct {
	...
	// PasswordSetByUser indicates whether the password was explicitly set by the user (true)
	// or automatically generated by the system during OTP/magic link signup (false)
	PasswordSetByUser bool `json:"password_set_by_user" db:"password_set_by_user"`
...
func (u *User) UpdatePassword(tx *storage.Connection, sessionID *uuid.UUID) error {
	...
	u.ReauthenticationSentAt = nil
	// Mark that the password was set by the user (not auto-generated by OTP/magic link)
	u.PasswordSetByUser = true

	if err := tx.UpdateOnly(u, "encrypted_password", "password_set_by_user", "confirmation_token", "confirmation_sent_at", "recovery_token", "recovery_sent_at", "email_change_token_current", "email_change_token_new", "email_change_sent_at", "phone_change_token", "phone_change_sent_at", "reauthentication_token", "reauthentication_sent_at"); err != nil {
		return err
	}
